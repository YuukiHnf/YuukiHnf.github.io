            ...
            <Box>
              ...
              <Box>
                <Typography variant="body1">
                  ...
                  に所属する修士２年生です．コンピュータを活用して，人々の社会的なつながりを強める方法を研究しています．特にコンピュータを使ってる人が「他の人と仲良くなる」/「コミュニティに参加したくなる」/「参加できなかったつながりに参加できる」ような
                  操作画面（UI）やデジタル体験（UX）をデザインすることに興味があります．未踏IT22年度スーパークリエータ.
                  株式会社 temaneki 代表．
                </Typography>
