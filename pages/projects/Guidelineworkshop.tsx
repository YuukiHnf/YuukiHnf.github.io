...
const title =
  "Workshop of Google Project Guideline in Sapporo, Hokkaido, Japan";
const materialURL = "/guidelineworkshop/";
const authors = "Yuki Abe, Kan Kusakabe";
const teaserCaption =
...
export default Guidelineworkshop;
